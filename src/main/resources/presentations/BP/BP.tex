...
%%\def\documentdate{\today}
    ...
    \begin{thebibliography}{11}
        \bibitem{Amigoscode2023}Amigoscode: \emph{Spring Boot 3 + Spring Security 6 - JWT Authentication and Authorisation [NEW] [2023]}. Youtube, 2023. \url{https://www.youtube.com/watch?v=KxqlJblhzfI}

        \bibitem{VisualComputerScience2023}Visual Computer Science: \emph{What is Spring-Boot Framework? (explained from scratch)}. Youtube, 2023. \url{https://www.youtube.com/watch?v=LSEYdU8Dp9Y}

        \bibitem{LearnDocker}Fireship: \emph{Learn Docker in 7 Easy Steps - Full Beginner's Tutorial}. 2021. \url{https://www.youtube.com/watch?v=gAkwW2tuIqE} (YouTube video, Accessed: 2024-07-23)

        \bibitem{SpringDataJPA2024}Spring Team: \emph{Accessing Data with JPA}. 2024. \url{https://spring.io/guides/gs/accessing-data-jpa} (Accessed: 2024-05-01)

        \bibitem{GerritMeyer2025}Gerrit Meyer: \emph{Why PostgreSQL is One of the Best Databases for Modern Applications and Why We Use It}. heisenware, 2025. \url{https://heisenware.com/en/blog/why-postgresql-is-one-of-the-best-databases-for-modern-applications}

        \bibitem{ThebenefitsofPostgreSQL}Justin Ellingwood: \emph{The benefits of PostgreSQL}. Prisma data guide. \url{https://www.prisma.io/dataguide/postgresql/benefits-of-postgresql}
        ...
        \bibitem{rfc5545}B. Desruisseaux: \emph{Internet Calendaring and Scheduling Core Object Specification (iCalendar)}. Internet Engineering Task Force, RFC 5545, 2009. \url{https://www.rfc-editor.org/rfc/rfc5545.html} (Accessed: 2024-05-01)

        \bibitem{Suryotrisongko2017}Hatma Suryotrisongko, Dedy Puji Jayanto, Aris Tjahyanto: \emph{Design and Development of Backend Application for Public Complaint Systems Using Microservice Spring Boot}. In: Procedia Computer Science, vol. 124, 2017. doi:10.1016/j.procs.2017.12.212

        \bibitem{Kozak2023}Mateusz Kozak: \emph{Analysis of the Spring Boot and Spring Cloud in developing Java cloud applications}. Journal of Computer Sciences Institute, vol. 27, 2023. doi:10.35784/jcsi.3130
    \end{thebibliography}

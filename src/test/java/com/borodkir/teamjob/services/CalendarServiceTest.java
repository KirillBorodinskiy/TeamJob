...
//        String[] eventTitles = {"Team Meeting", "Training Session", "Project Review", "Weekly Standup", "Monthly Planning"};
...
//        dayEvents.forEach(e -> System.out.println(e.getTitle() + " (" + e.getStartTimeToUse() + ", " + e.getEndTimeToUse() + ")"));
//
...
//        List<EventInADay> dayEvents = calendarService.convertToDayEvents(Collections.singletonList(event), baseDate, null, null);
//
//        // Debug output
...
//        List<EventInADay> dayEvents = calendarService.convertToDayEvents(Collections.singletonList(event), afterEndDate, null, null);
//
//        // Verify the event is not included
...
//        assertFalse(calendarService.convertToDayEvents(Collections.singletonList(event), firstMonth, null, null).isEmpty());
//        assertFalse(calendarService.convertToDayEvents(Collections.singletonList(event), secondMonth, null, null).isEmpty());
//        assertFalse(calendarService.convertToDayEvents(Collections.singletonList(event), thirdMonth, null, null).isEmpty());
//    }
//
//    @Test
